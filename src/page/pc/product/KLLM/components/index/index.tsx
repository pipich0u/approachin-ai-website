...
export const KllmIndex = () => {
    return <div className='kllm-index-container'>
        <div className='kllm-index-content'>
            <motion.div {...initialLoadProps} className='kllm-index-title'>KLLM推理引擎</motion.div>
            <motion.div {...initialLoadProps} className='kllm-index-desc'>AI时代企业级用户的大模型的操作系统</motion.div>
