...
export const MVaaSServe = () => {
    ...
    return <div className='mvaas-serve-container'>
        <div className='mvaas-serve-content'>
            <div className='mvaas-serve-title'>多种服务模式</div>
            <div className='mvaas-serve-box'>
                <div className='mvaas-serve-item mvaas-serve-left'>
                    <div className='mvaas-serve-top'>
                        <div className='mvaas-serve-top-title'>合作共创</div>
                        <div className='mvaas-serve-top-desc'>适合需要快速获取定制服务的企业</div>
                    </div>
                    <div className='mvaas-serve-bottom'>
                        <div className='mvaas-serve-bottom-items'>
                            <div className='mvaas-serve-bottom-items-icon'>{icon}</div>
                            <div className='mvaas-serve-bottom-items-title'>已建MaaS平台</div>
                            <div className='mvaas-serve-bottom-items-desc'>能力整合</div>
                        </div>
                        <div className='mvaas-serve-bottom-items'>
                            <div className='mvaas-serve-bottom-items-icon'>{icon}</div>
                            <div className='mvaas-serve-bottom-items-title'>算力中心或运营商</div>
                            <div className='mvaas-serve-bottom-items-desc'>场景能力开发</div>
                        </div>
                        <div className='mvaas-serve-bottom-items'>
                            <div className='mvaas-serve-bottom-items-icon'>{icon}</div>
                            <div className='mvaas-serve-bottom-items-title'>大型互联网企业</div>
                            <div className='mvaas-serve-bottom-items-desc'>个性化需求定制</div>
                        </div>
                    </div>
                </div>
                <div className='mvaas-serve-item mvaas-serve-right'>
                    <div className='mvaas-serve-right-items'>
                        <div className='mvaas-serve-right-items-text'>
                            <div className='mvaas-serve-top-title'>私有化</div>
                            <div className='mvaas-serve-top-desc'>适合对数据私密性和控制性要求较高的企业</div>
                        </div>
