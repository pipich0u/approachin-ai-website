            ...
            <div className='mob-kt-box'>
                ...
                <div className='mob-kt-container'>
                    <div className='mob-kt-left'>
                        <div className='mob-kt-left-content'>
                            <div className='mob-kt-left-content-item ktbg-1'>
                                ...
                                <div className='mob-kt-left-content-item-content'>趋境科技与清华大学 KVCache.AI 团队合作开源</div>
                            </div>
                            <div className='mob-kt-left-content-item ktbg-2'>
                                <div className='mob-kt-left-content-item-title'>超强算力</div>
                                <div className='mob-kt-left-content-item-content'>业界首个仅需单个消费级 GPU+CPU 即可在本地运行DeepSeek 671B 等千亿级别大模型，Prefill 最高达 436 tokens/s，Decode 最高达 2140 tokens/s，最高超过 Llama.cpp 30 倍。</div>
                            </div>
                    ...
                    <div className='mob-kt-right'>
                        <video controls className='mob-vido'  poster={cover} disablePictureInPicture controlsList="nodownload noremoteplayback noplaybackrate">
